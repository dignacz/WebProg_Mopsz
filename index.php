...
<html>
<head>
	<title>Mopszmentés – Mopszokért Alapítvány</title>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="container">
    <!-- Navbar brand -->
    <a class="navbar-brand me-2" href="https://mopszmentes.hu/">
      <img
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      ...
      <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll">
        ...
        <li class="nav-item">
          <a class="nav-link" href="index.php?page=mopsz">Mopsz Fajtamentés</a>
        </li>
        <li class="nav-item">
      ...
      if (isset($_SESSION['username'])) {
        $myConnection= mysqli_connect('localhost', 'root', '', 'mopszmentes_beadando') or die ("could not connect to mysql"); 
...
<footer class="text-center text-lg-start" style="background-color: #db6930;">
  ...
  <div class="text-center text-white p-3" style="background-color: rgba(0, 0, 0, 0.2);">
    © 2022 Copyright:
    <a class="text-white" href="https://mopszmentes.hu/">Mopszmentes.hu</a>
  </div>
  <!-- Copyright -->
</footer>
